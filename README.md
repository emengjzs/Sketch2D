...
- Contributors:    
  ...
  - Zak Penn [microsmadiopenn@gmail.com](mailto:microsmadiopenn@gmail.com)


- Ziseon  emengjzs@163.com    
...
![cocos2d](D:\Program\Git\Sketch2D-src\image\cocos2d.png)
...
同时场景是层的容器，包含了所有需要显示的游戏元素。通常，当我们需要完成一个场景时候，会创建**一个Scene的子类，并在子类中实现我们需要的功能**。
